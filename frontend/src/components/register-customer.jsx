...
export default class RegisterCustomer extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <PageTitle bold="Register" normal=" as customer" />
                <div className="container">
                    <form>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-10">
                                <input type="phone" className="form-control" id="phone" placeholder="+919876543210" required onChange={this.handleChange} />
                                {
                                    this.state.isError &&
